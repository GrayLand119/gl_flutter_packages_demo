 ...
 * on 2020/12/3
 */
class GLBaseDialog extends StatefulWidget {
  final String title;
  ...
  @override
  _GLBaseDialogState createState() => _GLBaseDialogState();
}

class _GLBaseDialogState extends State<GLBaseDialog> with SingleTickerProviderStateMixin {
